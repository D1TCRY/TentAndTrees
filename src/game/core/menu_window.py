...
class MenuWindow(tk.Tk):
    ...
    def _build_ui(self) -> None:
        ...
        # RULES
        rules = tk.Label(root, text="Select a level to start the game. "
                                    "Choose random to generate a random level. "
                                    ...
                                    "'Esc' to open the menu.", font=("Consolas", 8), wraplength=self.w-20)

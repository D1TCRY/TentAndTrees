...
# GAME
from ..board_game_gui import BoardGameGui, gui_get_mouse_pos, gui_get_current_keys, init_canvas, clear_canvas
...
def main() -> None:
    """Entry point"""
    global SCALE, FPS
    app = App(get_keys_from=gui_get_current_keys, get_mouse_pos_from=gui_get_mouse_pos)
